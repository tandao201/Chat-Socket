...
public class MessagePanel extends JPanel {
	...
	public MessagePanel(MessageData data) {
		...
		if (data.type.equals("notify")) {
			...
			textContent.setEditable(false);
			textContent.setAlignmentX(SwingConstants.RIGHT);
...
//		if (data.whoSend.equals(Main.socketController.userName)) {
//			whoSendLabel.setAlignmentX(Component.RIGHT_ALIGNMENT);
